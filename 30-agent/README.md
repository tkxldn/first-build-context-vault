# 30-agent/ — Optional: If You Are Building an Agent
...
|---|---|---|
| [31-my-agent.md](31-my-agent.md) | The character of your agent — its name, personality, values, how it communicates, what it notices, and what it would never do. Once you have chosen a name, rename this file to match. | 30–40 min |
| [32-rules.md](32-rules.md) | How your agent operates — what it can do on its own initiative, what it must always check with you first, and what is never its call | 25–35 min |

Do `31-my-agent.md` first. Rules without character are hollow — define who the agent is before you define how it behaves.
